...
sudo sed -i '/registry\.sumapay\.com$/d' /etc/cloud/templates/hosts.debian.tmpl
echo '192.161.14.101  registry.sumapay.com' | sudo tee -a /etc/cloud/templates/hosts.debian.tmpl
